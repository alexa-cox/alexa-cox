...
I'm a Full Stack JavaScript Developer passionate about crafting clean, efficient web solutions. Currently expanding my development toolkit and building exciting web applications.

###

<div align="center">
  <img src="https://streak-stats.demolab.com?user=alexa-cox&locale=en&mode=weekly&theme=dracula&hide_border=true&border_radius=5" height="150" alt="streak graph"  />
  <img src="https://github-readme-stats.vercel.app/api/top-langs?username=alexa-cox&locale=en&hide_title=false&layout=compact&card_width=320&langs_count=5&theme=dracula&hide_border=true" height="150" alt="languages graph"  />
</div>

###

## 🔧 Tech Stack
- **Frontend:** React, React Native, HTML5, CSS3, SASS, Bootstrap
- **Backend:** Currently diving deep into Node.js
- **Database:** Learning MongoDB

🌱 I'm on a journey to master the MERN stack while building practical applications that solve real-world problems.
